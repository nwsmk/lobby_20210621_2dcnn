...
from keras.layers import Dense, Conv2D, GlobalMaxPooling2D, Flatten, AveragePooling2D, Dropout, MaxPooling2D
...
if __name__ == '__main__':
    ...
    f_train_path = "/data/users/c3471tl/lobby_20210621_2dcnn/dataset/20210621/train/"
    ...
    f_test_path = "/data/users/c3471tl/lobby_20210621_2dcnn/dataset/20210621/test/"
    ...
    # create model
    f_save_path = '/data/users/c3471tl/lobby_20210621_2dcnn/'
    for count in range(10):
        model = Sequential()
        model.add(Conv2D(32, (13, 6), input_shape=(30, 6, 1), activation='relu'))
